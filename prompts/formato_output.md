...
* ⚠️ VINCOLO DI FEDELTÀ ESTREMA: Quando compili il tag <original>, non ricostruire il codice a memoria, non riassumere, non presumere che sia in un certo modo. Devi eseguire una ricerca testuale nell'ultima versione nota (che include le tue eventuali ultime modifiche!), individuare il blocco esatto di righe e copiarlo carattere per carattere, inclusi i commenti. Se il contenuto di <original> non è identico al 100% al file sorgente attuale, l'intera operazione fallirà.
