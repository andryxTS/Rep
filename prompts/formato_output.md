...
* Ciò che è contenuto in <original> è assolutamente FEDELE al file originale che ti ho passato in contesto (se te l'ho passato più volte vale l'ultima, ma quando iteriamo tieni anche conto delle ultime modifiche che tuoi puoi aver apportato). ⚠️ VINCOLO DI FEDELTÀ ESTREMA: Quando compili il tag <original>, non ricostruire il codice a memoria, non riassumere, non presumere che sia in un certo modo. Devi eseguire una ricerca testuale nell'ultima versione che ti ho inviato, individuare il blocco esatto di righe e copiarlo carattere per carattere, inclusi i commenti. Se il contenuto di <original> non è identico al 100% al file sorgente ultima versione, l'intera operazione fallirà. Se hai dubbi sulla versione esatta, chiedi conferma invece di ipotizzare.
